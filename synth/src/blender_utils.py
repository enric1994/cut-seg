...
def render_keyframes(output_folder, image_id, dataset_name):
	os.makedirs('/blender/datasets/{}/{}'.format(dataset_name, output_folder), exist_ok=True)
	image_paths = []
	# for i in range(0,total_frames):
	bpy.context.scene.frame_current = 0
	bpy.context.scene.render.image_settings.file_format = 'PNG'
	bpy.context.scene.render.filepath = '/blender/datasets/{}/{}/{}.png'.format(dataset_name, output_folder, str(image_id).zfill(8))
